...
CATLOGO = "https://telegra.ph/file/979fe639e5e6b325c8c68.jpg"
...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**iqthonbot"):
            buttons = [
                (
                    ...
                    Button.url("الريبو", "https://github.com/YASEEN15/Yasee33"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/YASEEN15/Yasee33"),
                Button.url(
                    "Deploy",
        ...
        result = types.InputBotInlineResult(
            ...
            url="http://heroku.com/deploy?template=https://github.com/YASEEN15/Yasee33",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
