...
LOGS = logging.getLogger("تليثون ياسين المصري")
cmdhr = Config.COMMAND_HAND_LER
try:
    LOGS.info("بدء تنزيل تليثون ياسين المصري")
...
async def startup_process():
    ...
    print(f"<b> ⌔︙ اهلا بك لقد نصبت تليثون ياسين المصري  (7.7) بنجاح 🥁 اذهب الى قناتنا لمعرفة المزيـد ⤵️. </b>\n CH : @y_a_n_u_u ")
    await verifyLoggerGroup()
